...
from stormnet.settings import ALLOWED_HOSTS
...
def send_activation_notification(user):
    ...
    body_text = render_to_string('main/email/activation_letter_body.txt', context)
...
def send_new_comment_notification(comment):
    ...
    body_text = render_to_string('main/email/new_comment_letter_body.txt', context)
